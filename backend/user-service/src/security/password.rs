...
/// Argon2 is a memory-hard password hashing algorithm resistant to GPU attacks
use argon2::{
...
///
/// # Returns
/// * `Result<(), argon2::password_hash::Error>` - Ok if verification succeeds, Err otherwise
