...
-- Ensure only one active key at a time using partial unique index
...
COMMENT ON COLUMN jwt_signing_keys.created_by IS 'Actor who generated the key (system or admin user ID)';
