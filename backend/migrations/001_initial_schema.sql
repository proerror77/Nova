...
CREATE INDEX IF NOT EXISTS idx_email_verifications_is_used ON email_verifications(is_used) WHERE is_used = FALSE;
...
CREATE INDEX IF NOT EXISTS idx_password_resets_is_used ON password_resets(is_used) WHERE is_used = FALSE;
