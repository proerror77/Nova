...
//! before they cause "broken pipe" errors during actual feed operations.
//!
...
pub async fn start_redis_health_check(feed_cache: Arc<FeedCache>, config: RedisHealthConfig) {
    if !config.enabled {
