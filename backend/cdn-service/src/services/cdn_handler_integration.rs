...
use crate::services::origin_shield::OriginShield;
use std::sync::Arc;
...
impl CdnHandler {
    ...
    pub fn new(config: VideoConfig) -> Self {
        ...
        Self {
            cdn_service: Arc::new(CdnService::new(config.cdn.clone())),
...
pub struct CdnHandlerResponse {
    ...
    pub geo_routing: crate::services::cdn_service::GeographicRouting,
    pub provider: String,
    pub cache_stats: crate::services::cdn_service::CacheStats,
    pub failover_stats: crate::services::cdn_failover::FailoverStats,
    pub shield_stats: crate::services::origin_shield::ShieldStats,
