fn main() {
    ...
    let services = vec![
        ...
        ("messaging_service", format!("{}/messaging_service.proto", base)),
        ...
        ("notification_service", format!("{}/notification_service.proto", base)),
        ("streaming_service", format!("{}/streaming_service.proto", base)),
