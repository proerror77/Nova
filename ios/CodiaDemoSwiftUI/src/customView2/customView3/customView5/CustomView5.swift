    ...
    var body: some View {
        ZStack(alignment: .topLeading) {
            ...
            Image(image49Path)
                ...
                .frame(width: 378, height: 212, alignment: .topLeading)
                .offset(x: 8, y: 149)
            Image(image50Path)
                .resizable()
                .aspectRatio(contentMode: .fit)
                .frame(width: 379, height: 149, alignment: .topLeading)
                .offset(x: 7)
        }
        .frame(width: 393, height: 2609, alignment: .topLeading)
    }
}
